...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <input type="text"name="busqueda" placeholder="Buscar por nombre" class="form-control mb-2" aria-label="Search">
                ...
                <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$cine->nombre}}</td>
                        <td>{{$cine->genero}}</td>
                        <td><form action="{{ route('peliculas.eliminar', $cine) }}" class="d-inline" method="POST">
                                @method('DELETE')
                                @csrf
